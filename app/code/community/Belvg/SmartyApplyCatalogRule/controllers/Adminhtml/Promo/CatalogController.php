...
class Belvg_SmartyApplyCatalogRule_Adminhtml_Promo_CatalogController extends Mage_Adminhtml_Promo_CatalogController {
    ...
    {
        $errorMessage = Mage::helper('catalogrule')->__('Unable to apply rule.');
        try {
            Mage::getModel('catalogrule/rule')->applyRule($this->getRequest()->getParam('rule_id'));
            Mage::getModel('catalogrule/flag')->loadSelf()
                ->setState(0)
                ->save();
            $this->_getSession()->addSuccess(Mage::helper('catalogrule')->__('The rule have been applied.'));
        } catch (Mage_Core_Exception $e) {
